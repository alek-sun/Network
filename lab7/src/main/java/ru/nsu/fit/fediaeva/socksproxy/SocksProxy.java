...
import ru.nsu.fit.fediaeva.socksproxy.socksprotocolspecs.*;
...
public class SocksProxy implements Runnable {
    ...
    private void handleAccept(SelectionKey selectionKey) throws IOException {
        ...
        clientSelectionKey.attach(new SocketChannelRef(socksClient, SocketChannelRef.SocketChannelSide.CLIENT));
    }
    ...
    private void connectToDestination(SocksClient socksClient, InetSocketAddress address) throws IOException {
        ...
        destSelectionKey.attach(new SocketChannelRef(socksClient, SocketChannelRef.SocketChannelSide.DESTINATION));
